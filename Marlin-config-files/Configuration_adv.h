 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 90        // Seconds  - edit Diego
  #define THERMAL_PROTECTION_HYSTERESIS 15     // Degrees Celsius  - edit Diego
 ...
 */
   ...
   */
  #define WATCH_COOLER_TEMP_PERIOD             90 // Seconds
 ...
 */
#define INPUT_SHAPING_X  // Diegolgo: activa correccion de vibraciones para los ejes.
#define INPUT_SHAPING_Y  // Diegolgo
  ...
  #define SHAPING_MENU                // Add a menu to the LCD to set shaping parameters.  Diegolgo
#endif
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY  // Diego: activado para ver si se puede manejar "apagado"
    ...
    #define POWER_LOSS_RECOVER_ZHOME  // Diego: home xy solamente para usar con power loss
  ...
  #define UTF_FILENAME_SUPPORT // Diego : nombres largos en SD
 ...
 */
#define FWRETRACT  // Diego: activa retraccion por firmware, para setear M207 y se activa el menu directo en la impresora
 ...
 */
#define ADVANCED_PAUSE_FEATURE // Diegolgo: activa pausas, para cambiar filamento
 ...
 */
//#define HOST_ACTION_COMMANDS   // Diegolgo: no estoy seguro de su funcionalidad
